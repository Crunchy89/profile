...
const Home = () => {
  ...
  return (
    ...
    <div className="d-flex flex-column justify-content-center align-items-start w-75 mx-auto text-light h-100 mt-3">
            ...
            <p className="mt-2" align='justify'>Lahir pada 11 Mei 1989. Dengan Pengalaman lebih dari beberapa tahun di front-end dan back-end. Bergairah dalam mempelajari hal baru dan selalu mengikuti perkembangan teknologi terkini</p>
